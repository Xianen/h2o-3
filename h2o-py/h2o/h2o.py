...
def init(ip="localhost", port=54321, start_h2o=True, enable_assertions=True,
         ...
         strict_version_check=True, proxy=None, nthreads=-1, max_mem_size_GB=None, min_mem_size_GB=None):
  ...
  H2OConnection(ip=ip, port=port,start_h2o=start_h2o,enable_assertions=enable_assertions,license=license,
                ...
                strict_version_check=strict_version_check,proxy=proxy,nthreads=nthreads,max_mem_size_GB=max_mem_size_GB,
